...
const API_DASHBOARD = `http://34.125.178.201/app/api/residente/dashboard.php?id=${params.get('id')}&action=`;
const API_USUARIOS = `http://34.125.178.201/app/api/residente/index.php?id=${params.get('id')}&action=`;
