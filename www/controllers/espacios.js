...
const API_ESPACIO = `http://34.125.178.201/app/api/residente/espacios.php?id=${params.get('id')}&action=`;
const ENDPOINT_ESTADO = `http://34.125.178.201/app/api/residente/espacios.php?id=${params.get('id')}&action=readSpaceStatus`;
            ...
            content += `
                    <div class="animate__animated animate__bounceIn col-xl-4 col-md-4 col-sm-12 col-xs-12 mt-4 d-flex margenTarjetas justify-content-center align-items-center text-center">
                        ...
                        <!-- Fila para Imagen -->
                            <div class="row">
                                <div class="col-12">
                                    <img src="http://34.125.178.201/resources/img/dashboard_img/espacios_fotos/${row.imagenprincipal}" alt="#" class="img-fluid fit-images fotoEspacio imagenTarjeta">
                                </div>
                            </div>
            ...
            content += `
                    <div class="animate__animated animate__bounceIn col-xl-4 col-md-4 col-sm-12 col-xs-12 mt-2 d-flex margenTarjetas justify-content-center align-items-center text-center">
                        ...
                        <!-- Fila para Imagen -->
                            <div class="row">
                                <div class="col-12">
                                    <img src="http://34.125.178.201/resources/img/no-image.png" alt="#" class="img-fluid fit-images fotoEspacio imagenTarjeta">
                                </div>
                            </div>
                            <!-- Fila para Información -->
                            <div class="row mt-2">
        ...
        content += `
         ...
         <div class="animate__animated animate__bounceIn col-xl-4 col-md-4 col-sm-12 col-xs-12 mt-4 d-flex margenTarjetas justify-content-center align-items-center text-center">
                            ...
                            <div class="tarjeta2">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                    <a href="http://34.125.178.201/resources/img/dashboard_img/espacios_fotos/${row.imagen}" data-lightbox="mygallery" data-image-alt="Image 1">
                                        <img src="http://34.125.178.201/resources/img/dashboard_img/espacios_fotos/${row.imagen}" alt="Thumbnail 1" width="250px" height="150px" class="imagenTarjeta">
                                    </a>                                    
                                </div>
                                    </div>
                                <!-- Fin de Tarjeta -->
