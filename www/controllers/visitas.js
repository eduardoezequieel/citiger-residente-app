...
const API_VISITA = `http://34.125.178.201/app/api/residente/visitas.php?id=${params.get('id')}&action=`;
const ENDPOINT_VISITANTE = `http://34.125.178.201/app/api/residente/visitas.php?id=${params.get('id')}&action=readVisitante`;
//Al cargar la pagina
