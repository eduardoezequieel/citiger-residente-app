...
const API_ALQUILERES = `http://34.125.178.201/app/api/residente/alquileres.php?id=${params.get('id')}&action=`;
const ENDPOINT_ESTADO_ALQUILER = `http://34.125.178.201/app/api/residente/alquileres.php?id=${params.get('id')}&action=readRentalStatus`;
const ENDPOINT_ESPACIO_ALQUILERES = `http://34.125.178.201/app/api/residente/alquileres.php?id=${params.get('id')}&action=readSpace`;
