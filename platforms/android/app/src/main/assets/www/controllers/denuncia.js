...
const API_DENUNCIA = `http://34.125.88.216/app/api/residente/denuncia.php?id=${params.get('id')}&action=`;
const ENDPOINT_ESTADO = `http://34.125.88.216/app/api/residente/denuncia.php?id=${params.get('id')}&action=readComplaintStatus`;
const ENDPOINT_TIPO = `http://34.125.88.216/app/api/residente/denuncia.php?id=${params.get('id')}&action=readComplaintType`;
//Al cargar la pagina
            ...
            <tr class="animate__animated animate__fadeIn">
                <th scope="row">
                    <div class="row paddingTh">
                        <div class="col-12">
                            <img src="http://34.125.88.216/resources/img/userIcon.png" alt="#"
